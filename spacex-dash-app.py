...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'All':
        ...
        outcomes = filtered_df['Launch Site'].value_counts().reset_index()
        outcomes.columns = ['Launch Site', 'Count']
        fig = px.pie(outcomes, values='Count', 
        names='Launch Site', 
...
def update_scatter_chart(selected_site, payload_range):
    ...
    fig = px.scatter(
        ...
        title=f'Mission Outcome vs Payload for {selected_site if selected_site != "All" else "All Sites"}',
